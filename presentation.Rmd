...
- 309 "generic ballot" polls from Real Clear Politics

- Polls from January, 2017 - November, 2018

- Example:

\includegraphics{data_snap.PNG}


## Initial Bootstrapping

- Estimate difference in popular vote proportion
...
- 95% Bootstrapped CI: `r round(ci_noweight,4)*100`
...
- Linear regression with sample size weights
...
- Change probability of being selected in the bootstrap
    ...
    - Higher weight for recent polls
    
    - Higher weight for *Likely* *Voters* 
    
- Use "relative support" to account for undecided/independent
